  ...
  return (
    <div className='p-4'>
      <div className='flex justify-between intems-center'>
        <h1 className='text-4x1 my-10'>Books on Shelf</h1>
        <Link to='/books/save/'>
                ...
                <td className='border border-slate-700 rounded-md text-center'>
                  <div className='flex justify-center gap-x-4'>
                    <Link to={`/books/get/${book._id}`}>
                      <BsInfoCircle className='text-3x1 text-green-800' />
                    </Link>
                    <Link to={`/books/edit/${book._id}`}>
                      <AiOutlineEdit className='text-3x1 text-yellow-600' />
                    </Link>
                    <Link to={`/books/delete/${book._id}`}>
                      <MdOutlineDelete className='text-3x1 text-red-600' />
                    </Link>
                  </div>
                </td>
              </tr>
